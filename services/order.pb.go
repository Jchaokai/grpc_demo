...
type OrderRequest struct {
	Order                *ProductInfo `protobuf:"bytes,1,opt,name=order,proto3" json:"order,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *OrderRequest) GetOrder() *ProductInfo {
	if m != nil {
		return m.Order
	}
	return nil
...
var fileDescriptor_cd01338c35d87077 = []byte{
	...
	,
}
...
func (c *orderClient) NewOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/services.Order/NewOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedOrderServer) NewOrder(ctx context.Context, req *OrderRequest) (*OrderResponse, error) {
...
func _Order_NewOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/services.Order/NewOrder",
	}
